      ...
      <main className="max-w-7xl mx-auto px-8 py-20">
        <div className="text-center mb-16">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              to="/signup"
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-violet-600 text-white rounded-lg text-lg hover:shadow-xl transition-all"
            >
              Create account
            </Link>
            <Link
              to="/signin"
              className="px-8 py-4 bg-white text-gray-700 rounded-lg text-lg border-2 border-gray-200 hover:border-blue-300 transition-all"
            >
              Sign in
            </Link>
          </div>
