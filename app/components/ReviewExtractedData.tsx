...
export default function ReviewExtractedData() {
  ...
  if (!receiptId) {
    return (
      <div className="text-center py-16 text-gray-400">
        No receipt to review. <button onClick={() => navigate('/dashboard/upload')} className="text-blue-600 hover:underline">Upload one</button>
      </div>
    )
  }
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Review Extracted Data</h1>

      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-start gap-3">
        <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
        <p className="text-blue-800 text-sm">
          Please review the extracted data before saving. You can edit any field if needed.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h2 className="text-lg font-semibold text-gray-800 mb-6">Receipt Information</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Extracted Items</h2>
            {items.length === 0 ? (
