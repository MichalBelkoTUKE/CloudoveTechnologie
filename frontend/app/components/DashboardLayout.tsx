...
import { getStoredUser, signOut } from "../../src/lib/auth";
    ...
    <div className="flex h-screen bg-gray-50">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-xl font-semibold bg-linear-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">
            SmartReceipt AI
          </h1>
        </div>
      ...
      <main className="flex-1 overflow-auto">
        <header className="bg-white border-b border-gray-200 px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="w-10 h-10 rounded-full bg-linear-to-r from-blue-500 to-violet-500 flex items-center justify-center text-white font-semibold">
              {initials}
            </div>
          </div>
        </header>
